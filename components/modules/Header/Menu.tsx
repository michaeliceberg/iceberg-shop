...
const Menu = () => {
  ...
  const concreteLinks = [
    {
      id: 1,
      text: translations[lang].comparison.bstgraviy,
      href: '/catalog/concrete?offset=0&type=bstgraviy',
    },
    {
      id: 2,
      text: translations[lang].comparison.bstgranit,
      href: '/catalog/concrete?offset=0&type=bstgranit',
    },
    {
      id: 3,
      text: translations[lang].comparison.keramzitobeton,
      href: '/catalog/concrete?offset=0&type=keramzitobeton',
    },
    {
      id: 4,
      text: translations[lang].comparison.rastvor,
      href: '/catalog/concrete?offset=0&type=rastvor',
    },
    {
      id: 5,
      text: translations[lang].comparison.dorozhnotransportniy,
      href: '/catalog/concrete?offset=0&type=dorozhnotransportniy',
    },
    {
      id: 6,
      text: translations[lang].comparison.bstmodif,
      href: '/catalog/concrete?offset=0&type=bstmodif',
    },
  ]
  ...
  const asphaltLinks = [
    {
      id: 1,
      text: translations[lang].comparison.asph_b,
      href: '/catalog/asphalt?offset=0&type=asph_b',
    },
    {
      id: 2,
      text: translations[lang].comparison.asph_c,
      href: '/catalog/asphalt?offset=0&type=asph_c',
    },
    {
      id: 3,
      text: translations[lang].comparison.asph_a,
      href: '/catalog/asphalt?offset=0&type=asph_a',
    },
  ]
