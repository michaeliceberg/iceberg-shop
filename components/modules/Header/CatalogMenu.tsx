...
const CatalogMenu = () => {
  ...
  const items = [
    {
      name: translations[lang].main_menu.concrete,
      id: 1,
      items: [
        translations[lang].comparison.bstgraviy,
        translations[lang].comparison.bstgranit,
        translations[lang].comparison.keramzitobeton,
        translations[lang].comparison.rastvor,
        translations[lang].comparison.dorozhnotransportniy,
        translations[lang].comparison.bstmodif,
      ],
