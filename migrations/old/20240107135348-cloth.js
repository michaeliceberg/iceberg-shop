...
const concreteTypes = ['t-shirts', 'long-sleeves', 'hoodie', 'outerwear']
const images = [
  '/img/concretees/concrete-hoodie-1.png',
  '/img/concretees/concrete-long-sleeves-1.png',
  '/img/concretees/concrete-long-sleeves-2.png',
  '/img/concretees/concrete-outerwear-1.png',
  '/img/concretees/concrete-outerwear-2.png',
  '/img/concretees/concrete-t-shirts-1.png',
  '/img/concretees/concrete-t-shirts-2.png',
]
const lineImages = [
  '/img/black-t.png',
  '/img/violet-t.png',
...
module.exports = {
  async up(db) {
    return db.collection('concrete').insertMany(
      [...Array(50)].map(() => {
        const type = concreteTypes[Math.floor(Math.random() * concreteTypes.length)]
