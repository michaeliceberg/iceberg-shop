...
const accessoryTypes = ['asph_b', 'asph_c', 'asph_a']
const images = [
  '/img/asphalt/asphalt-asph_b-1.png',
  '/img/asphalt/asphalt-asph_b-2.png',
  '/img/asphalt/asphalt-asph_b-3.png',
  '/img/asphalt/asphalt-asph_b-4.png',
  '/img/asphalt/asphalt-asph_c.png',
  '/img/asphalt/asphalt-asph_a.png',
]
...
module.exports = {
  async up(db) {
    return db.collection('asphalt').insertMany(
      [...Array(50)].map(() => {
        const type =
  ...
  async down(db) {
    return db.collection('asphalt').updateMany([])
  },
}
